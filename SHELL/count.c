...
commands for running programming output
1)cout c a.txt   - for print all number of character
2)cout w a.txt   - for print all number of words
3)cout l a.txt   - for print all number of lines
*/
